...
<html>
   ...
   <body>
     <div class="container">  
     <h1>Edit Book</h1>  
       <form:form method="post" action="/SpringMVCWithBootstrapping/book/editSaveBook">    
        <table class="table">    
        <tr>  
        	<td></td>    
         ...
         <tr>    
          <td colspan="2" class="text-center">
          	...
          	<a href="<%=request.getContextPath()%>/book/getAllBooks" class="btn btn-warning">Cancel</a>
          </td>  
         </tr>    
        </table>    
       </form:form>    
